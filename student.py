...
class Student:
    def __init__(self,root):
        ...
        img = Image.open(r"c:\Users\Parshuram  Dalwai\OneDrive\Desktop\Face recognition - Copy\images\download.jpeg")
        ...
        #second image
        img1 = Image.open(r"c:\Users\Parshuram  Dalwai\OneDrive\Desktop\Face recognition - Copy\images\download (1).jpeg")
        ...
        #third image
        img2 = Image.open(r"c:\Users\Parshuram  Dalwai\OneDrive\Desktop\Face recognition - Copy\images\ig2.jpg")
        ...
        #bg imge
        img3=Image.open(r"c:\Users\Parshuram  Dalwai\OneDrive\Desktop\Face recognition - Copy\images\ig3.jpg")
        ...
        img_left = Image.open(r"c:\Users\Parshuram  Dalwai\OneDrive\Desktop\Face recognition - Copy\images\ig2.jpg")
        img_left = img2.resize((720,130))
        ...
        dept_combo=ttk.Combobox(current_course_frame,textvariable=self.var_dept,font=("times new roman",13,"bold"),state="readonly",width=17)
        ...
        #classdivision
        class_divison=Label(class_student_frame,text="Class Divison",font=("times new roman",13,"bold"),bg="white")
        class_divison.grid(row=1,column=0,padx=10,pady=5,sticky=W)    
        ...
        #Rollno
        student_rollno=Label(class_student_frame,text="RollNo",font=("times new roman",13,"bold"),bg="white")
        student_rollno.grid(row=1,column=2,padx=10,pady=5,sticky=W)    
          
        studentrollno_entry =ttk.Entry(class_student_frame,textvariable=self.var_roll,width=20,font=("times new roman",13,"bold"))
        studentrollno_entry.grid(row=1,column=3,padx=10,pady=5,sticky=W)
        
        #Gender
        student_gender=Label(class_student_frame,text="Gender",font=("times new roman",13,"bold"),bg="white")
        ...
        #TeacherName
        teacher_name=Label(class_student_frame,text="Teacher's Name",font=("times new roman",13,"bold"),bg="white")
        teacher_name.grid(row=4,column=2,padx=10,pady=5,sticky=W)    
        ...
        radiobutton1=ttk.Radiobutton(class_student_frame,variable=self.var_radio1,text="Photo Sample",value="Yes")
        ...
        save_button=Button(button_frame,text="Save", command=self.add_data, width=17,font=("times new roman",13,"bold"),bg="black",fg="white")
        save_button.grid(row=0,column=0)
        
        update_button=Button(button_frame,text="Update", command=self.update_data, width=17,font=("times new roman",13,"bold"),bg="black",fg="white")
        update_button.grid(row=0,column=1)
        
        delete_button=Button(button_frame,text="Delete", command=self.delete_data,width=17,font=("times new roman",13,"bold"),bg="black",fg="white")
        delete_button.grid(row=0,column=2)
        
        reset_button=Button(button_frame,text="Reset", command=self.reset_data,width=17,font=("times new roman",13,"bold"),bg="black",fg="white")
        ...
        take_photo_button=Button(button_frame1,command=self.generate_dataset,text="Take Photo Sample", width=35,font=("times new roman",13,"bold"),bg="black",fg="white")
        take_photo_button.grid(row=0,column=0)
        
        update_photo_button=Button(button_frame1,text="Update Photo Sample", width=35,font=("times new roman",13,"bold"),bg="black",fg="white")
        ...
        img_right = Image.open(r"c:\Users\Parshuram  Dalwai\OneDrive\Desktop\Face recognition - Copy\images\ig2.jpg")
        img_right = img2.resize((720,130))
     ...
     #search system
        ...
        search_label=Label(search_frame,text="Search By:",font=("times new roman",15,"bold"),bg="brown",fg="white")
        ...
        search_btn_button=Button(search_frame,text="Search", width=12,font=("times new roman",12,"bold"),bg="black",fg="white")
        search_btn_button.grid(row=0,column=3,padx=4)
        ...
        self.student_table=ttk.Treeview(table_frame,column=("dept","course","year","sem","id","name","div","roll","gender","dob","email","phone","address","teacher's name","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
    ...
    def generate_dataset(self):
        if self.var_dept.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                self.reset_data()
                conn.close()
                self.capture_and_save_images(id)
            except Exception as es:
                messagebox.showerror("Error",f"Due to :{str(es)}",parent=self.root)
                
                #loadpredefined data on face frontals from opencv
    def capture_and_save_images(self,id):
                cascade_path ="c:\\Users\\Parshuram  Dalwai\\OneDrive\\Desktop\\Face recognition - Copy\\haarcascade_frontalface_default.xml"
                ...
                while True:
                    ...
                    if face_cropped(my_frame) is not None:
                        ...
                        if os.path.exists(folder_path):
                            ...
                            cv2.putText(face,str(img_id),(150,150),cv2.FONT_HERSHEY_COMPLEX,2,(0,255,0),2,cv2.LINE_AA,False)
                            cv2.imshow("Cropped Face",face)
                        else:
                            print("Folder not found or lacks write permissions.")
